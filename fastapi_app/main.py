...
Q1. Drill and Hammer
Answer: 15
Explanation: "If the drill and hammer together cost $330, and the drill costs $300 more than the hammer, then the hammer must cost $15."

Q2. Dog and Cat
Answer: 72
Explanation: "If the dog weighs 86 pounds and together they weigh 100 pounds, then the difference between them is 72 pounds."

Q3. Baby Bird
Answer: 11
Explanation: "If the baby bird doubles its weight each day and weighs a pound on day 12, then the day before, day 11, it must have weighed 0.5 lb."

Q4. Toaster Discount
Answer: 125
Explanation: "If the toaster costs $100 when it's 20% off, then adding the 20% back makes the full price $125."

Q5. Rachel's Height Rank
Answer: 29
Explanation: "If Rachel is 15th from both the front and back, there are 14 girls on each side of her, plus herself — 14 + 1 + 14 = 29 girls in total."

Q6. Elves and Gifts
Answer: 30
Explanation: "If 30 elves can wrap 30 gifts in 30 minutes, then each elf wraps 1 gift in 30 minutes. With 40 elves each wrapping 1 gift, it will still take 30 minutes to finish 40 gifts."

Q7. Jack and Jill's Bottle
Answer: 4
Explanation: "If Jack can finish a bottle in 6 days and Jill takes 12 days (Jack drinks 1/6 and Jill 1/12 of a bottle per day), together that’s 1/4 per day, so they finish in 4 days."

Q8. Green and Red Apples
Answer: 15
Explanation: "If there are 60 apples and green ones are one-third as common as red ones, then red + green = 60 → 3x + x = 60 → x = 15 green apples."
...
def log_to_sheets(prolific_pid: str, bot_id: str, role: str, content: str) -> None:
    ...
    try:
        ...
        arm_str = "crt-correct" # Fixed arm for this experiment
        role_str = str(role)
